...
grammar Fortran2018 {
    ...
    #`[R516] token keyword {:i [
        |  <name>
    ] }

    #`[R601] token alphanumeric-character {:i [
        |  <.letter>
        |  <.digit>
        |  "_"
    ] }
...
#EJH#         |  <complex-part-designator>
    ...
    #`[R1006] rule level-two-expr {:i [
        |  <add-op>? <add-operand>+ % <add-op>
    ] }

    #`[R1010] rule level-three-expr {:i [
        |  <level-two-expr>+ % <concat-op>
    ] }

    #`[R1012] rule level-four-expr {:i [
        |  <level-three-expr>+ % <rel-op>
    ] }
    ...
    #`[R1017] rule level-five-expr {:i [
        |  <equiv-operand>+ % <equiv-op>
    ] }

    #`[R1022] rule expr {:i [
        |  <level-five-expr>+ % <defined-binary-op>
    ] }

#EJH#     #`[R1022] rule expr {:i [
#EJH#         |  <level-four-expr>
#EJH#     ] }
